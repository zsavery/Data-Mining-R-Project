...
pairs.panels(newICU[c('Error-category', 'Date-of-error', 'Contributing-factor', 'Medication-process-node', 'Location-of-error', 'Type-of-error', 'Staff-type-perpetuated-error', 'Staff-type-discovered-error')])
```
...
```{r}
cor(data_num[c("Report_number","Facility_id","Error_category","Date_of_error","Type_of_error","Cause_of_error", 'Staff-type-initiated-error')])
```
